...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7116266807:AAFiuS4MxcubBiHRyzKEDnmYPCRiS0f3aGU")
...
CHANNEL_ONE = int(os.environ.get("CHANNEL_ONE", "-1002047241550"))
CHANNEL_TWO = int(os.environ.get("CHANNEL_TWO", "-1002005436412"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\nI can store private files of anime Warrior Tamil Channel and other users can access it from special link.")
try:
    ADMINS=[6299192020]
